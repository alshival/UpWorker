...
**NOTE**: Currently, you can browse jobs through the app, but you cannot submit proposals when you try to apply from the webview (though applying from popup windows still works). To submit a proposal, click on the globe in the bottom right corner to open it in your browser. Perhaps in the future we will get this feature to work, but there appears to be some issue with the site's cookies or javascript in WebView2.
